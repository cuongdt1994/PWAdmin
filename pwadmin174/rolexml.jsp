...
<div id="mainContent">
    <form name="content" action="index.jsp?page=rolexml" method="post" class="phx-form-group" style="margin: 0px;">
        <div class="phx-form-group" style="text-align: right;">
            <label class="phx-label">Character ID</label>
            <input name="ident" type="text" value="<% out.print(id); %>" class="phx-input">
            <select name="type" class="phx-input">
                <option value="id">by ID</option>
            </select>
            <button class="phx-btn phx-btn-secondary">View</button>
        </div>
    </form>
    <br>
        ...
        <table class="phx-table">
            ...
            <tr>
                <td colspan="3" align="left" valign="top">
                    <textarea name="xml" rows="24" class="phx-input" style="font-family: monospace; min-height: 400px; width: 100%; box-sizing: border-box;"><%out.print(StringEscapeUtils.escapeHtml(xml));%></textarea>
                </td>
            </tr>
            <%
                if(allowed)
                {
                    out.println("<tr>");
                    out.println("<td colspan=\"3\" align=\"center\"><button class=\"phx-btn phx-btn-primary\">Save XML</button></td>");
                    out.println("</tr>");
                }
            %>
            </form>
    ...
    <%-- Debug output disabled: debugOutput --%>
</div>
