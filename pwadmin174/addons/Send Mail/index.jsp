...
<%@include file="items/items-00.jsp"%>
...
<div class="phx-page-header">
    <h1><i class="fa-solid fa-envelope" style="color:var(--phx-primary)"></i> <%= T("sendmail.title") %></h1>
    ...
    <form action="index.jsp?process=mail" method="post">
        ...
        <div class="phx-form-group">
            ...
            <select class="phx-select" name="choice" size="1" onChange="jump(this.form)">
                ...
                <option value="./items/index-01.jsp">Mounts</option>
                <option value="./items/index-02.jsp">Pets</option>
                <option value="./items/index-03.jsp">Utility</option>
                <option value="./items/index-04.jsp">Clothing</option>
                <option value="./items/index-05.jsp">Materials</option>
                <option value="./items/index-06.jsp">Apothecary</option>
                <option value="./items/index-07.jsp">Chi</option>
                <option value="./items/index-08.jsp">Wines</option>
                <option value="./items/index-09.jsp">Oracles</option>
                <option value="./items/index-10.jsp">Cube Of Fate</option>
                <option value="./items/index-11.jsp">Misc.</option>
                <option value="./items/index-12.jsp">Twilight Temple</option>
                <option value="./items/index-13.jsp">Twilight Temple Souledges</option>
                <option value="./items/index-14.jsp">Frost</option>
                <option value="./items/index-15.jsp">Lunar Glade</option>
                <option value="./items/index-16.jsp">Sage & God</option>
                <option value="./items/index-17.jsp">DragonQuest</option>
                <option value="./items/index-18.jsp">Projectiles</option>
                <option value="./items/index-19.jsp">Gems</option>
                <option value="./items/index-20.jsp">Legendary Weapon Molds</option>
                <option value="./items/index-21.jsp">Legendary Arm Molds</option>
                <option value="./items/index-22.jsp">Misc. Legendary</option>
                <option value="./items/index-23.jsp">Legendary Ornament Molds</option>
            </select>
            </form>
        </div>
