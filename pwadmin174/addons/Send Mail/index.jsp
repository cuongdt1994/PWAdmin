...
<option value="./items/index-01.jsp">Mounts</option><br>
<option value="./items/index-02.jsp">Pets</option><br>
<option value="./items/index-03.jsp">Utility</option><br>
<option value="./items/index-04.jsp">Clothing</option><br>
<option value="./items/index-05.jsp">Materials</option><br>
<option value="./items/index-06.jsp">Apothecary</option><br>
<option value="./items/index-07.jsp">Chi</option><br>
<option value="./items/index-08.jsp">Wines</option><br>
<option value="./items/index-09.jsp">Oracles</option><br>
<option value="./items/index-10.jsp">Cube Of Fate</option><br>
<option value="./items/index-11.jsp">Misc.</option><br>
<option value="./items/index-12.jsp">Twilight Temple</option><br>
<option value="./items/index-13.jsp">Twilight Temple Souledges</option><br>
<option value="./items/index-14.jsp">Frost</option><br>
<option value="./items/index-15.jsp">Lunar Glade</option><br>
<option value="./items/index-16.jsp">Sage & God</option><br>
<option value="./items/index-17.jsp">DragonQuest</option><br>
<option value="./items/index-18.jsp">Projectiles</option><br>
<option value="./items/index-19.jsp">Gems</option><br>
<option value="./items/index-20.jsp">Legendary Weapon Molds</option><br>
<option value="./items/index-21.jsp">Legendary Arm Molds</option><br>
<option value="./items/index-22.jsp">Misc. Legendary</option><br>
<option value="./items/index-23.jsp">Legendary Ornament Molds</option><br>
</select>
</form>
</td>
</tr>
